...
def train_on_device(obj_names, args):
    ...
    for obj_name in obj_names:
        ...
        model2 = ReconstructiveSubNetwork(in_channels=3, out_channels=3)
        model2.cuda()
        ...
        model_seg2 = DiscriminativeSubNetwork(in_channels=6, out_channels=2)
        model_seg2.cuda()
        model_seg2.apply(weights_init)

        optimizer = torch.optim.Adam([
                                      {"params": model.parameters(), "lr": args.lr},
                                      {"params": model_seg.parameters(), "lr": args.lr},
                                      {"params": model2.parameters(), "lr": args.lr},  ##
                                      {"params": model_seg2.parameters(), "lr": args.lr}])
        ...
        for epoch in range(args.epochs):
            ...
            for i_batch, sample_batched in enumerate(dataloader):
                ...
                out_mask2 = model_seg2(joined_in2)
                out_mask_sm2 = torch.softmax(out_mask2, dim=1)
                # loss2
                segment_loss2 = loss_focal(out_mask_sm2, anomaly_mask)
                ...
                loss = l2_loss + ssim_loss + segment_loss + \
                       l2_loss2 + ssim_loss2  + segment_loss2
            ...
            torch.save(model_seg2.state_dict(), os.path.join(args.checkpoint_path, run_name+"_seg2.pckl"))
